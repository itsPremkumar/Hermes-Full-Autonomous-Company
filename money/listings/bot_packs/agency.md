# I will build a lead-qualifying AI bot for your agency

**Price:** $800 setup + $199/mo
**Margin:** 90%
**Tags:** ai chatbot, customer support, chatwoot, agency bot, ai assistant, support automation
...
## Delivery process
- 1. Collect KB source (services + case studies + pricing tiers)
- 2. Train bot on Hermes/OpenClaw + build intents
- 3. Deploy on Chatwoot across: website widget + Messenger
