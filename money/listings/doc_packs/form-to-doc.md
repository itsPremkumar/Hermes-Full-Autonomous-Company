# I will turn your forms & surveys into branded PDF reports

**Price:** $149/gig
**Margin:** —%
**Tags:** pdf report, form automation, survey to pdf, stirling pdf, n8n, branded documents, report automation
...
```json
{
 ...
 "note": "Tools: Stirling-PDF + n8n + Listmonk (email) \u2014 all free/self-hosted. Replace code node with your doc logic."
}
```
