# I will deploy a 24/7 AI voice receptionist for your plumbing business

**Price:** $1200/gig
**Margin:** —%
**Tags:** ai voice agent, phone answering, plumbing automation, virtual receptionist, chatwoot, n8n, small business automation, missed call recovery
...
## Delivery process
- **Basic** ($300, 3 days): Single-line agent; 1 script; Email support
- **Standard** ($1200, 5 days): Full voice agent; Booking/CRM hook; Loom walkthrough; 7-day support
- **Premium** ($2400, 7 days): Multi-line + escalation; Unlimited scripts; Monthly retainer option; Priority support
...
```json
{
 "name": "deliver-voice-agent-plumbing",
 "nodes": [
  {
   "parameters": {},
 ...
 "note": "Tools: Piper (local TTS) + Whisper (local STT) + Hermes/OpenClaw + Chatwoot + n8n \u2014 all free/self-hosted. Replace code nodes with your STT/LLM/TTS logic."
}
```
