# I will deploy an AI voice agent that qualifies real-estate leads by phone

**Price:** $1400/gig
**Margin:** —%
**Tags:** ai voice agent, real estate lead gen, lead qualification, speed to lead, n8n, crm automation, virtual assistant
...
## Delivery process
- **Basic** ($350, 3 days): Single-line agent; 1 script; Email support
- **Standard** ($1400, 5 days): Full voice agent; Booking/CRM hook; Loom walkthrough; 7-day support
- **Premium** ($2800, 7 days): Multi-line + escalation; Unlimited scripts; Monthly retainer option; Priority support
...
```json
{
 "name": "deliver-voice-agent-realestate",
 "nodes": [
  {
   "parameters": {},
