# I will generate your legal contract or proposal

**Price:** $120/gig
**Margin:** —%
**Tags:** legal document, contract generator, proposal writer, freelance contract, nda, docassemble
...
## Delivery process
- **Basic** ($30, 3 days): Setup only; 1 workflow; Email support
- **Standard** ($120, 5 days): Setup + test; Up to 3 workflows; Loom walkthrough; 7-day support
- **Premium** ($240, 7 days): Full system; Unlimited workflows; Monthly retainer option; Priority support
...
```json
{
 ...
 "note": "Tools: DocAssemble + Hermes drafting + your doc-extractor skill. Replace code node with your delivery logic."
}
```
